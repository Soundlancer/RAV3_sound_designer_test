...
public class occlusion_sound_music : MonoBehaviour
{
    ...
    {
        AkSoundEngine.SetRTPCValue("RTPC_Occlusion_music", lineCastHitCount / 9); // устанавливаем RTPC в нужное положение
    }
