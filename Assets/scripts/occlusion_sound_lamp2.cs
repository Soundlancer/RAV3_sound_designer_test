...
public class occlusion_sound_lamp2 : MonoBehaviour
{
    ...
    void CheckOcclusion(Vector3 sound, Vector3 player) // кидаем рейкасты
    {
    ...
    {
        AkSoundEngine.SetRTPCValue("RTPC_Occlusion_lamp2", lineCastHitCount / 9); // устанавливаем RTPC в нужное положение
    }
