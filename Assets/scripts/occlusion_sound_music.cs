...
public class occlusion_sound_rain : MonoBehaviour
{
    ...
    {
        AkSoundEngine.SetRTPCValue("RTPC_Occlusion_rain", lineCastHitCount / 9); // устанавливаем RTPC в нужное положение
    }
